...
internal class GlideLoader : ImageLoader {
    ...
    override fun loadThumbnail(imageView: ImageView, resize: Int, defaultDrawable: Int, path: String) {
    ...
    override fun loadImage(imageView: ImageView, resizeW: Int, resizeH: Int, path: String) {
