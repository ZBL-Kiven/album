...
/**
 * @author zjj/yangji on 19/10/16
 */
public class PhotoGraphAdapter extends BaseAdapter<FileInfo> {

    private ChangeListener listener;
    private int mImageResize = 0;

    public PhotoGraphAdapter(ChangeListener listener) {
        super(R.layout.graph_item_selected);
        this.listener = listener;
    }

    @Override
    protected void initData(BaseViewHolder holder, int position, FileInfo data) {

    }

    private void initVisible(BaseViewHolder holder,Boolean isVideo) {
        holder.getView(R.id.photo_cb_original)
    }
